...
function LoginForm() {
  ...
  return (
    <div className="w-[500px]">
      <div className="bg-white rounded-md p-3 overflow-hidden mt-2">
        <div className="relative mt-2">
          <h1 className="text-center font-light text-xl ">
            Team <span className="font-bold">Login</span>
          </h1>
          <button className="absolute top-1/2 -translate-y-1/2 left-1 border rounded-full p-2">
            <svg
        ...
        <div className="p-5 mt-4">
          ...
          <h2 className="text-sm mt-6 leading-7">
            To continue, please sign in with your registered KIIT gmail account
          </h2>
          <Button
